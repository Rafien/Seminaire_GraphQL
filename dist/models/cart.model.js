...
let Cart = (() => {
    let _classDecorators = [(0, graphql_1.ObjectType)(), (0, sequelize_typescript_1.Table)({ tableName: 'carts' })];
    ...
    (() => {
        ...
        _items_decorators = [(0, graphql_1.Field)(() => [cart_item_model_1.CartItem]), (0, sequelize_typescript_1.HasMany)(() => cart_item_model_1.CartItem)];
